# Generated by Django 3.1.1 on 2021-01-28 08:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='NEO的个人网站，记录生活的瞬间，分享学习的心得，感悟生活，留住感动', help_text='用来作为SEO中description,长度参考SEO标准', max_length=240, verbose_name='描述')),
                ('keywords', models.TextField(default='NEO,网络,IT,技术,博客,Python', help_text='用来作为SEO中keywords,长度参考SEO标准', max_length=240, verbose_name='关键字')),
            ],
            options={
                'verbose_name': '大分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keywords', models.ManyToManyField(help_text='文章关键词，用来作为SEO中keywords，最好使用长尾词，3-4个足够', to='myblog.Keyword', verbose_name='文章关键词')),
